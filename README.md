...
- Include [PR 3: Correct hotkey command](https://github.com/eth-p/fish-plugin-sudo/pull/3), to fix [issue 2: fish: Unknown command: __ethp_commandline_toggle_sudo.fish](https://github.com/eth-p/fish-plugin-sudo/issues/2).
- Patch `sudo` function, to allow `sudo -i` command to still work
